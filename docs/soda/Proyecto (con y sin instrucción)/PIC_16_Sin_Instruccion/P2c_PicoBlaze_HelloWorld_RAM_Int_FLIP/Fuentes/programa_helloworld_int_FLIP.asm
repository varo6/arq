...
wait_1bit:	LOAD 		cont1, 0003  
espera2:	LOAD		cont2, 0022
espera1:	SUB		cont2, 0001
		JUMP		NZ, espera1
		SUB		cont1, 0001
		JUMP		NZ, espera2
		RETURN
...
wait_05bit:	LOAD 		cont1, 0003 
espera4:	LOAD		cont2, 0010
espera3:	SUB		cont2, 0001
		JUMP		NZ, espera3
		SUB		cont1, 0001
		JUMP		NZ, espera4
		RETURN
...
interrup:	DISABLE 	INTERRUPT
		CALL 		recibe
		;FLIP		rxreg
		;MIX		rxreg		;con esto cambiamos los 8 primeros bits de posicion con los 8 segundos
		LOAD 		txreg,rxreg
		CALL 		transmite
		ADD		S6,0030		;le sumamos el valor 30 a lo que recibimos, de manera que corresponda con el caracter ASCII de la tecla pulsada
		LOAD 		txreg,S6
		CALL 		transmite
		RETURNI		ENABLE
		ADDRESS		FFFF
