...
#define instruction_count 30/* total instruction set */             // Numero m�ximo de instrucciones
	...
	for(i = 0; i < line_count; i++){                                      // para todas las lineas del programa
		if(op[i].instruction != NULL){                                    // si la linea contiene codigo de operaci�n comprueba si conincide con las definidas en el juego de instrucciones
			...
			switch (j)                                                    // comprueba a que clase de codigo de operaci�n pertenece
			{
				...
				case 19: /* SLA */
				case 20: /* RL */
				case 29: /* TR */ /* added new instruction, same syntax with shift/rotate */
					if(op[i].op2 != NULL){
			...
			/* add (j > 28) for TR instruction, - added new instruction */
	...
	for(i = 0; i < line_count; i++){                                                     // para todas las lineas del programa               
		if(op[i].instruction != NULL){                                                   // si la linea contiene codigo de operaci�n comprueba si conincide con las definidas en el juego de instrucciones
			...
			switch (j)                                                                   // comprueba a que clase de codigo de operaci�n pertenece
			{
				...
				case 28: /* ADDRESS */
					break;
				case 29: /* TR */ /* added new instruction */                          // para el caso de instrucciones TR.   
					insert_instruction(tr_id, op[i].address);                          // inserta codigo m�quina del codigo de operacion.
